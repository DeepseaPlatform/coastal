...
public abstract class State {
	 ...
	 */
	public final static String INDEX_SEPARATOR = "$"; // "_D_"
	 ...
	 */
	public final static String CHAR_SEPARATOR = "!"; // "_H_"

	/**
	 * Prefix for new symbolic variables.
	 */
	public final static String NEW_VAR_PREFIX = "$"; // "U_D_"

	public final static String CREATE_VAR_PREFIX = "N_D_"; // "@"
