...
/**
 * Test cases that runs SVCOMP-2019 input files.
 *
 * At the moment, these tests are not run, but they exercise the system.  Some
 * are long-running (>15 minutes) and it is not feasible to run them all, but
 * others need to re-activated in the near future.
 */
@RunWith(Parameterized.class)
public class SVComp {

    /**
     * Method that returns test parameters.  Each entry in this collection
     * contains three values: (1) the name of the jar file that contains the
     * file-under-test, (2) the name of the file-under-test, and (3) the
     * expected outcome of the concolic run.
     *
...
//				{ "jpf-regression", "ExSymExeGetStatic_false", false },
                ...
                // MINEPUMP TESTS
                // ========================================
//                { "MinePump", "spec1-5_product10", false },
//                { "MinePump", "spec1-5_product11", false },
//                { "MinePump", "spec1-5_product12", false },
//                { "MinePump", "spec1-5_product13", false },
//                { "MinePump", "spec1-5_product14", false },
//                { "MinePump", "spec1-5_product15", false },
//                { "MinePump", "spec1-5_product16", false },
//                { "MinePump", "spec1-5_product17", false },
//                { "MinePump", "spec1-5_product18", false },
//                { "MinePump", "spec1-5_product19", false },
//                { "MinePump", "spec1-5_product1", false },
//                { "MinePump", "spec1-5_product20", false },
//                { "MinePump", "spec1-5_product21", false },
//                { "MinePump", "spec1-5_product22", false },
//                { "MinePump", "spec1-5_product23", false },
//                { "MinePump", "spec1-5_product24", false },
//                { "MinePump", "spec1-5_product25", false },
//                { "MinePump", "spec1-5_product26", false },
...
//                { "jayhorn-recursive", "UnsatMccarthy91", false },
    ...
    /**
     * Test parameter 1: the jar file that contains the file-under-test.
     */
    private String testDir;

    /**
     * Test parameter 2: the name of the file-under-test.
     */
    private String testSubDir;

    /**
     * Test parameter 3: the expected outcome of the concolic run.
     */
    private boolean testExpectedOutcome;

    /**
     * Constructor for a parameterised test.
     *
     * @param dir name of the jar file that contains the file-under-test
     * @param subDir name of the file-under-test
     * @param expectedOutcome expected outcome of the concolic run
     */
    ...
    /**
     * Perform one test run of the parameterised test.  The test parameters are
     * set by the constructor.  This method uses those parameters to construct a
     * COASTAL instance and then runs COASTAL on the file-under-test. All files
     * in the same jar file share the same properties.
     */
    @Ignore
    @Test
