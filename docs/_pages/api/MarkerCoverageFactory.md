---
title: MarkerCoverageFactory
permalink: /api/MarkerCoverageFactory/
toc: true
---
...
<h2><a class="anchor" name="MarkerCoverageFactory(COASTAL, ImmutableConfiguration)"></a>MarkerCoverageFactory</h2>
<div markdown="1">
~~~java
...
Constructors<ul>
<li class="toc-entry toc-h3">
<a href="{{ '/api/MarkerCoverageFactory/' | relative_url }}#MarkerCoverageFactory(COASTAL, ImmutableConfiguration)">MarkerCoverageFactory(COASTAL, ImmutableConfiguration)</a></li>
</ul>
</li>
<li class="toc-entry toc-h2">
Methods<ul>
<li class="toc-entry toc-h3">
<a href="{{ '/api/MarkerCoverageFactory/' | relative_url }}#createManager(COASTAL)">createManager(COASTAL)</a></li>
<li class="toc-entry toc-h3">
<a href="{{ '/api/MarkerCoverageFactory/' | relative_url }}#createObserver(COASTAL, ObserverFactory.ObserverManager)">createObserver(COASTAL, ObserverFactory.ObserverManager)</a></li>
<li class="toc-entry toc-h3">
<a href="{{ '/api/MarkerCoverageFactory/' | relative_url }}#getFrequencyflags()">getFrequencyflags()</a></li>
</ul>
</li>
