---
title: TraceBasedFactory.TraceBasedManager
permalink: /api/TraceBasedFactory.TraceBasedManager/
toc: true
---
...
<h2><a class="anchor" name="TraceBasedManager"></a>TraceBasedManager</h2>
<div markdown="1">
~~~java
...
Constants<ul>
<li class="toc-entry toc-h3">
<a href="{{ '/api/TraceBasedFactory.TraceBasedManager/' | relative_url }}#PROPERTY_NAMES">PROPERTY_NAMES</a></li>
</ul>
</li>
<li class="toc-entry toc-h2">
Fields<ul>
<li class="toc-entry toc-h3">
<a href="{{ '/api/TraceBasedFactory.TraceBasedManager/' | relative_url }}#broker">broker</a></li>
<li class="toc-entry toc-h3">
<a href="{{ '/api/TraceBasedFactory.TraceBasedManager/' | relative_url }}#coastal">coastal</a></li>
<li class="toc-entry toc-h3">
<a href="{{ '/api/TraceBasedFactory.TraceBasedManager/' | relative_url }}#pathTree">pathTree</a></li>
<li class="toc-entry toc-h3">
<a href="{{ '/api/TraceBasedFactory.TraceBasedManager/' | relative_url }}#refineCount">refineCount</a></li>
<li class="toc-entry toc-h3">
<a href="{{ '/api/TraceBasedFactory.TraceBasedManager/' | relative_url }}#strategyTime">strategyTime</a></li>
<li class="toc-entry toc-h3">
<a href="{{ '/api/TraceBasedFactory.TraceBasedManager/' | relative_url }}#strategyWaitCount">strategyWaitCount</a></li>
<li class="toc-entry toc-h3">
<a href="{{ '/api/TraceBasedFactory.TraceBasedManager/' | relative_url }}#strategyWaitTime">strategyWaitTime</a></li>
</ul>
</li>
<li class="toc-entry toc-h2">
Constructors<ul>
<li class="toc-entry toc-h3">
<a href="{{ '/api/TraceBasedFactory.TraceBasedManager/' | relative_url }}#TraceBasedManager">TraceBasedManager(COASTAL)</a></li>
</ul>
</li>
<li class="toc-entry toc-h2">
Methods<ul>
<li class="toc-entry toc-h3">
<a href="{{ '/api/TraceBasedFactory.TraceBasedManager/' | relative_url }}#getPathTree">getPathTree()</a></li>
<li class="toc-entry toc-h3">
<a href="{{ '/api/TraceBasedFactory.TraceBasedManager/' | relative_url }}#getPropertyNames">getPropertyNames()</a></li>
<li class="toc-entry toc-h3">
<a href="{{ '/api/TraceBasedFactory.TraceBasedManager/' | relative_url }}#getPropertyValues">getPropertyValues()</a></li>
<li class="toc-entry toc-h3">
<a href="{{ '/api/TraceBasedFactory.TraceBasedManager/' | relative_url }}#getTaskCount">getTaskCount()</a></li>
<li class="toc-entry toc-h3">
<a href="{{ '/api/TraceBasedFactory.TraceBasedManager/' | relative_url }}#incrementRefinements">incrementRefinements()</a></li>
<li class="toc-entry toc-h3">
<a href="{{ '/api/TraceBasedFactory.TraceBasedManager/' | relative_url }}#insertPath">insertPath(Execution, boolean)</a></li>
<li class="toc-entry toc-h3">
<a href="{{ '/api/TraceBasedFactory.TraceBasedManager/' | relative_url }}#insertPath0">insertPath0(Execution, boolean)</a></li>
<li class="toc-entry toc-h3">
<a href="{{ '/api/TraceBasedFactory.TraceBasedManager/' | relative_url }}#recordTime">recordTime(long)</a></li>
<li class="toc-entry toc-h3">
<a href="{{ '/api/TraceBasedFactory.TraceBasedManager/' | relative_url }}#recordWaitTime">recordWaitTime(long)</a></li>
<li class="toc-entry toc-h3">
<a href="{{ '/api/TraceBasedFactory.TraceBasedManager/' | relative_url }}#report">report(Object)</a></li>
</ul>
</li>
