---
title: LineCoverageFactory
permalink: /api/LineCoverageFactory/
toc: true
---
...
<h2><a class="anchor" name="LineCoverageFactory(COASTAL, ImmutableConfiguration)"></a>LineCoverageFactory</h2>
<div markdown="1">
~~~java
...
Constants<ul>
<li class="toc-entry toc-h3">
<a href="{{ '/api/LineCoverageFactory/' | relative_url }}#PROPERTY_NAMES">PROPERTY_NAMES</a></li>
</ul>
</li>
<li class="toc-entry toc-h2">
Constructors<ul>
<li class="toc-entry toc-h3">
<a href="{{ '/api/LineCoverageFactory/' | relative_url }}#LineCoverageFactory(COASTAL, ImmutableConfiguration)">LineCoverageFactory(COASTAL, ImmutableConfiguration)</a></li>
</ul>
</li>
<li class="toc-entry toc-h2">
Methods<ul>
<li class="toc-entry toc-h3">
<a href="{{ '/api/LineCoverageFactory/' | relative_url }}#createManager(COASTAL)">createManager(COASTAL)</a></li>
<li class="toc-entry toc-h3">
<a href="{{ '/api/LineCoverageFactory/' | relative_url }}#createObserver(COASTAL, ObserverFactory.ObserverManager)">createObserver(COASTAL, ObserverFactory.ObserverManager)</a></li>
<li class="toc-entry toc-h3">
<a href="{{ '/api/LineCoverageFactory/' | relative_url }}#getFrequencyflags()">getFrequencyflags()</a></li>
</ul>
</li>
