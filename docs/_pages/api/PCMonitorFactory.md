---
title: PCMonitorFactory
permalink: /api/PCMonitorFactory/
toc: true
---
...
<h2><a class="anchor" name="PCMonitorFactory(COASTAL, ImmutableConfiguration)"></a>PCMonitorFactory</h2>
<div markdown="1">
~~~java
...
Constructors<ul>
<li class="toc-entry toc-h3">
<a href="{{ '/api/PCMonitorFactory/' | relative_url }}#PCMonitorFactory(COASTAL, ImmutableConfiguration)">PCMonitorFactory(COASTAL, ImmutableConfiguration)</a></li>
</ul>
</li>
<li class="toc-entry toc-h2">
Methods<ul>
<li class="toc-entry toc-h3">
<a href="{{ '/api/PCMonitorFactory/' | relative_url }}#createManager(COASTAL)">createManager(COASTAL)</a></li>
<li class="toc-entry toc-h3">
<a href="{{ '/api/PCMonitorFactory/' | relative_url }}#createObserver(COASTAL, ObserverFactory.ObserverManager)">createObserver(COASTAL, ObserverFactory.ObserverManager)</a></li>
<li class="toc-entry toc-h3">
<a href="{{ '/api/PCMonitorFactory/' | relative_url }}#getFrequencyflags()">getFrequencyflags()</a></li>
</ul>
</li>
